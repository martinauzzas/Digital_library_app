...
# Setting variable for class instantiation
...
class Book(db.Model):
    ...
    def __init__(self, isbn, title, author, length, genre, year, user_token):
        self.isbn = isbn
        self.title = title
        self.author = author
        self.length = length
    ...
    def __repr__(self):
        return f'The following book has been added to the Digital Library: {self.title}'
...
class BookSchema(ma.Schema):
    class Meta:
        fields = ['isbn', 'title','author','length', 'genre', 'year']
